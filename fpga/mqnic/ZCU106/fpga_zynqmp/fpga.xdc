...
# SFP+ Interface
set_property -dict {LOC AA2} [get_ports sfp0_rx_p]
set_property -dict {LOC AA1} [get_ports sfp0_rx_n]
set_property -dict {LOC Y4} [get_ports sfp0_tx_p]
set_property -dict {LOC Y3} [get_ports sfp0_tx_n]
...
set_property -dict {LOC U10} [get_ports sfp_mgt_refclk_0_p]
set_property -dict {LOC U9} [get_ports sfp_mgt_refclk_0_n]
...
set_false_path -from [get_clocks clk_pl_0] -to [get_clocks -of_objects [get_pins {phy_inst/eth_pcspma/inst/pcs_pma_block_i/transceiver_inst/gig_ethernet_pcs_pma_0_gt_i/inst/gen_gtwizard_gthe4_top.gig_ethernet_pcs_pma_0_gt_gtwizard_gthe4_inst/gen_gtwizard_gthe4.gen_channel_container[0].gen_enabled_channel.gthe4_channel_wrapper_inst/channel_inst/gthe4_channel_gen.gen_gthe4_channel_inst[0].GTHE4_CHANNEL_PRIM_INST/RXOUTCLK}]]
